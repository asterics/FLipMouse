...
// English: 1/4 x 20.
//english_thread (diameter=3/8, threads_per_inch=20, length=0.5);
//fillet(10,2);
color("black"){
    linear_extrude(height = 1.5) {
        polygon(points = [[9,-7],[9,7],[7,9],[-7,9],[-9,7],[-9,-7],[-7,-9],[7,-9]]);
    }
    english_thread (diameter=3/8, threads_per_inch=10, length=1);
}
